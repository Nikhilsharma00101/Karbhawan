        ...
        <div className="space-y-6 md:space-y-12 pb-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-2">
                    <h2 className="text-3xl md:text-5xl heading-luxe text-aether-primary">Products</h2>
                    <p className="text-aether-secondary font-medium italic text-sm md:text-base">Manage your product inventory.</p>
                </div>
                <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                    <form action={migrateProductCategories} className="w-full sm:w-auto">
                        <button
                            type="submit"
                            className="w-full sm:w-auto flex items-center justify-center gap-3 bg-white border border-slate-100 text-aether-secondary px-6 py-4 md:px-8 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] shadow-sm hover:bg-slate-50 transition-all duration-300"
                    ...
                    <Link
                        ...
                        className="w-full sm:w-auto flex items-center justify-center gap-3 bg-gradient-to-r from-cta-soft to-cta-blue text-white px-6 py-4 md:px-8 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] shadow-lg shadow-blue-100/50 hover:scale-[1.02] transition-all duration-300"
                    >
                    ...
                    <table className="w-full text-left border-collapse min-w-[900px]">
                        <thead>
                            <tr className="bg-slate-50 border-b border-slate-100 text-[10px] font-black uppercase tracking-[0.3em] text-aether-muted">
                                <th className="p-4 md:p-8 font-black">Product</th>
                                <th className="p-4 md:p-8 font-black">Price</th>
                                <th className="p-4 md:p-8 font-black">Stock</th>
                                <th className="p-4 md:p-8 font-black">Category</th>
                                ...
                                <tr key={product._id} className="hover:bg-slate-50/50 transition-colors group">
                                    <td className="p-4 md:p-8">
                                        <div className="flex items-center gap-4 md:gap-6">
                                            <div className="relative w-12 h-12 md:w-16 md:h-16 rounded-2xl overflow-hidden bg-white border border-slate-100 flex-shrink-0 group-hover:scale-110 transition-transform duration-500 shadow-sm">
                                                {product.images[0] && (
                                                    <Image
                                            ...
                                            <div className="space-y-1.5">
                                                <p className="text-aether-primary font-display font-bold text-sm md:text-lg leading-none">{product.name}</p>
                                                {product.featured && (
                                    ...
                                    <td className="p-4 md:p-8 text-right">
                                        <div className="flex items-center justify-end gap-3 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300">
                                            <Link
